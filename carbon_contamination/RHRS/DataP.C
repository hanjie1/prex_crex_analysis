...
void DataP(){
   ...
   TString datafile1 = "/lustre/expphy/volatile/halla/parity/ryanrich/prexRootFiles/prexRHRS_21424_-1_file0.root";
   TString datafile2 = "/lustre/expphy/volatile/halla/parity/ryanrich/prexRootFiles/prexRHRS_21188_-1_file0.root";
   TString datafile3 = "/lustre/expphy/volatile/halla/parity/ryanrich/prexRootFiles/prexRHRS_21419_-1_file0.root";

   T_c->Add(datafile1);
   T_pb->Add(datafile2);
   T_ca->Add(datafile3);

   TString MCfile1 = "../g4hrs_rootfiles/prex_c12_RHRS.root";
   TString MCfile2 = "../g4hrs_rootfiles/prex_pb208_RHRS.root";
   TString MCfile3 = "../g4hrs_rootfiles/prex_ca40_RHRS.root";
...
TCut downCut9 = Form("-x_zdown9 > (%f+%f) && -x_zdown9 < (%f-%f) && y_zdown9 > (%f+1.5*%f) && y_zdown9 < (%f-1.5*%f)",xmin[10],tol,xmax[10],tol,ymin[10],tol,ymax[10],tol);
   ...
   T_ca->Draw("HacR_D1_NMR_SIG>>hNMR_ca");
   ...
   T_c->Draw("(1.+R.gold.dp)*(2.702*(HacR_D1_NMR_SIG)-1.6e-03*pow(HacR_D1_NMR_SIG,3))*1000>>hp_c",TRK);
   T_pb->Draw("(1.+R.gold.dp)*(2.702*(HacR_D1_NMR_SIG)-1.6e-03*pow(HacR_D1_NMR_SIG,3))*1000>>hp_pb",TRK);
   T_ca->Draw("(1.+R.gold.dp)*(2.702*(HacR_D1_NMR_SIG)-1.6e-03*pow(HacR_D1_NMR_SIG,3))*1000>>hp_ca",TRK);
   ...
   hpMC_c->SetTitle("RHRS C12 momentum; p (MeV);");
   ...
   hpMC_pb->SetTitle("RHRS Pb208 momentum; p (MeV);");
   ...
   hp_ca->SetTitle("RHRS Ca40 momentum; p (MeV);");
 
   c1->Print("outfiles/momentum_RHRS.pdf");
